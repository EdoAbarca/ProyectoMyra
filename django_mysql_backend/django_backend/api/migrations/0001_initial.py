    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idCargo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.cargo')),
                ('idCentro', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.centro')),
                ('pacientes', models.ManyToManyField(related_name='lista_pacientes_c', to='api.paciente')),
                ('profesionales', models.ManyToManyField(related_name='lista_profesionales_c', to='api.profesional')),
            ],
        ),
        migrations.CreateModel(
            name='Asistencia',
